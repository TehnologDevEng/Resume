...
export default function App() {
  return (
    <div className="min-h-screen bg-background relative overflow-hidden text-text-primary selection:bg-primary/30">
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 lg:px-24 relative z-10">
        ...
        <footer className="py-8 border-t border-border mt-12 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-text-muted">
          <p>© {new Date().getFullYear()} {portfolioData.name}. Все права защищены.</p>
          <div className="flex gap-6">
            <a href={`mailto:${portfolioData.email}`} className="hover:text-primary transition-colors">Email</a>
